...
{
    if (vertical) {
//        assert(mat1.cols() == mat2.cols() && "Math::MakeBlockMatrix(mat1, mat2, blockMat, vertical) : when vertical is true, mat1.cols() must be equal mat2.cols()");
...
//        assert(mat1.rows() == mat2.rows() && "Math::MakeBlockMatrix(mat1, mat2, blockMat, vertical) : when vertical is false, mat1.rows() must be equal mat2.rows()");
